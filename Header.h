...
#define p_H 7.0
#define Omega 0.0
#define N 32000 //(8000) // 1792 //2816 //  2048                // Количество ячеек по x
#define M (400) // 1536 // 2304 // 1792                // Количество ячеек по y
...
#define hx -100.4
#define grad_p true
#define Nmin 2              // Каждую какую точку выводим?
...
#define wat_ ((200)*N + 16000)   // Какую ячейку смотрим
#define wat2_ ((200)*N + 18000)   // Какую ячейку смотрим
#define wat3_ ((250)*N + 16000)   // Какую ячейку смотрим
...
#define krit 0.05  // 0.25   0.2 было   0.02 норм для ТВД
#define ggg (5.0/3.0)          // Показатель адиабаты
#define ga (5.0/3.0)          // Показатель адиабаты
